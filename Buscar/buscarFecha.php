...
<form method="post">
            ...
            <table>
                <tr>
                    <td>FECHA INICIO:</td>
                    <td> 
                    <input type="date" name="dtIni" value="" size="25" maxlength="30"></input>
                    </td>          
                </tr>
                <tr>
                    <td>FECHA FIN :</td>
                    <td> 
                    <input type="date" name="dtFin" value="" size="25" maxlength="30"></input>
...
if($_POST['btnbuscar']=="buscar"){
    ...
    $ini= $_POST['dtIni'];
    $fin =$_POST['dtFin'];
    $sql ="select * from clientes where Fnac between '$ini' and '$fin'";
